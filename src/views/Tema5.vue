...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mt-5 El social media es un fenómeno de interacción social que se ha convertido en la puerta de entrada para dar y recibir información a través de los medios digitales. Teniendo en cuenta la evidencia de la comunicación bidireccional generada, se podría afirmar, desde la perspectiva de Dotras (2018), que #[b “el social media consiste en construir relaciones”, lo cual se ajusta muy bien a la realidad.]
    ...
    TabsC.color-acento-contenido.mt-5
      .py-3.py-md-4(titulo="Comunicación")
        .row.justify-content-center.align-items-center
          .col-md-5.mb-4.mb-md-0
            figure
              img.img-a.img-t(src='@/assets/ilustraciones/img35.svg', alt='')
          ...
          .col-md-1.px-0.d-none.d-lg-block.mt-4 
            .hr-card  
          .col-md-3.px-0.mt-4  
            ul.lista-ul.br-card
              li 
      ...
      .py-3.py-md-4(titulo="Colaboración")
        .row.justify-content-center.align-items-center
      ...
      .py-3.py-md-4(titulo="Multimedia")
        .row.justify-content-center.align-items-center
          .col-md-6.mb-4.mb-md-0
            figure
      ...
      .py-3.py-md-4(titulo="Entretenimiento")
        .row.justify-content-center.align-items-center
          .col-md-6.mb-4.mb-md-0
            figure
              img.img-a.img-t(src='@/assets/ilustraciones/img38.svg', alt='')
    ...
    .row.justify-content-center.align-items-center.mt-5
      .col-7
        ...
        .p Para realizar esta medición existen diversas herramientas en línea, como Hootsuite Analytics, Google Analytics, Brandwatch, Talkwalker, etc. 
    ...
    p.mt-5 Por lo anterior, las plataformas tienen dentro de los términos y condiciones de uso un apartado que bien podría entenderse como un contrato de adhesión, que es aceptado desde el momento en que se abre una cuenta como nuevo usuario. En este sentido, es importante identificar, a continuación, la normatividad colombiana que regula las identidades en la web y la propiedad intelectual. Adelante.       
    .row.justify-content-center.align-items-center.mt-5
      .col-10
